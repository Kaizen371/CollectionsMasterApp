...
namespace CollectionsMasterConsoleUI
{
    class Program
    {
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            ...
            {
                Console.WriteLine($"Number Found {searchNumber} is in the list");
            }
            else
            {
                Console.WriteLine($"Number Not Found {searchNumber} is not in the list");
            }
        }

        private static void Populater(List<int> numberList, int numbersToAdd)
        {
            Random rng = new Random();
